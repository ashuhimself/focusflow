...
Production-grade configuration for a multi-tenant Life Operating System.
"""
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'focusflow'),
...
# CSRF Trusted Origins (for admin and forms behind proxy)
...
if not DEBUG:
    ...
    # Don't redirect to HTTPS since nginx handles that
